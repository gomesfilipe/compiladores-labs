// Generated from /home/filipe/git/compiladores-labs/lab1/Java/exercicios/ezlang/Ezlang.g by ANTLR 4.9.2
...
public class Ezlang extends Lexer {
	...
	public static final int
		...
		UNTIL=17, VAR=18, WRITE=19, ASSIGN=20, EQ=21, LT=22, PLUS=23, MINUS=24, 
		TIMES=25, OVER=26, LPAR=27, RPAR=28, SEMI=29, INT_VAL=30, REAL_VAL=31, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"SEMI", "INT_VAL", "REAL_VAL", "STR_VAL", "ID", "UNKNOWN"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"UNTIL", "VAR", "WRITE", "ASSIGN", "EQ", "LT", "PLUS", "MINUS", "TIMES", 
			"OVER", "LPAR", "RPAR", "SEMI", "INT_VAL", "REAL_VAL", "STR_VAL", "ID", 
			"UNKNOWN"
		};
	}
